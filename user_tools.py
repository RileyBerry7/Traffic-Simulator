...
#     lane_translation    = calculate_slope_translation(perpendicularize_slope(center_median.slope), road_types.ROAD_TYPES[road_type]["lane_width"] * scale)
#     median_translation  = calculate_slope_translation(perpendicular_slope, (((road_types.ROAD_TYPES[road_type]["median_width"]) * scale / 2) +
#                                                                               road_types.ROAD_TYPES[road_type]["lane_width"] * scale / 2))
#
#     left_lanes  = []
#     right_lanes = []
#
...
# ########################################################################################################################
#
# def calculate_bounding_box(start_point: [float, float], end_point: [float, float], road_type: str):
#     """ Calculates the minimum size bounding box that the road geometry will fit into once draw.
#         The two point arguments represents a center median line that the lanes will be parallel
#         to and be built off from. """
#
#     scale = 10
#     center_median = Lane(Node(start_point), Node(end_point))
#     perpendicular_slope = perpendicularize_slope(center_median.slope)
#     lane_translation = calculate_slope_translation(perpendicularize_slope(center_median.slope),
#                                                        road_types.ROAD_TYPES[road_type]["lane_width"] * scale)
#     median_translation = calculate_slope_translation(perpendicular_slope, (
#                 ((road_types.ROAD_TYPES[road_type]["median_width"]) * scale / 2) +
#                 road_types.ROAD_TYPES[road_type]["lane_width"] * scale / 2))
#
#     ####################################################################################################################
#
